...
var GenTextures = function GenTextures(tileSize) {
    ...
    var createCorpus = function createCorpus(size) {
        var width = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0.6;
        ...
        return corpus.forEach(function (a, i, j) {
            var y = (j / corpus.size - 0.5) * 2;
            if (Math.abs(y) < size - 0.25) return 1;
            var k = (0, _utils.clamp)((size - Math.abs(y)) / 0.25, 0, 1);
            return Math.sqrt(k);
        }).normalize(0.5, 1).getColor([67, 114, 61], corpusMask);
    };
    var createTurret = function createTurret(size, barrelWidth, barrelLength) {
        ...
        var turretImg = smoothedSquare(turret, size, size).normalize(0, 1).getColor([67, 114, 61], turretMask);
...
var Level = exports.Level = function Level(levelName, canvas) {
    ...
    loadLevel(function () {
        ...
        _this.context.drawImage(_this.textures.turretSimple, 450, 600);

        _this.context.drawImage(_this.textures.trackSimple, 450, 700);
        _this.context.drawImage(_this.textures.corpusMedium, 450, 700);
        _this.context.drawImage(_this.textures.turretSimple, 450, 700);

        _this.context.drawImage(_this.textures.trackSimple, 550, 700);
        _this.context.drawImage(_this.textures.corpusEasy, 550, 700);
        ...
        _this.context.drawImage(_this.textures.turretSmall, 550, 600);

        _this.context.drawImage(_this.textures.trackBrone, 650, 600);
        _this.context.drawImage(_this.textures.corpusHard, 650, 600);
        _this.context.drawImage(_this.textures.turretBig, 650, 600);

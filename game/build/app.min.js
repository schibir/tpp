...
var GenTextures = function GenTextures(tileSize) {
    ...
    var createSparkBrickBeton = function createSparkBrickBeton(color) {
        var createSparkBrick = function createSparkBrick() {
            ...
            sparkBrickMask.normDist(Math.random()).normalize(0, 1).clamp(0.1, 0.3).normalize(0, 1);
        ...
        for (var _i12 = 0; _i12 < 10; _i12++) {
            ret[_i12] = [];
            ret[_i12].push(createSparkBrick());

...
var Game = function () {
    function Game(difficulty, canvas) {
        ...
        this.players = [new _tank.Tank(10, 10, _tank.TANK.TANK1), new _tank.Tank(15, 10, _tank.TANK.PANZER)];
...
var Tank = exports.Tank = function (_Entity) {
    ...
    function Tank(cx, cy, type) {
        ...
        _this.guanoShield = new _entity2.default(cx, cy, 3);
        return _this;
    }
    ...
    _createClass(Tank, [{
        ...
        value: function clear(level) {
            ...
            level.clearEntity(this.guanoShield);
        }
    }, {
        key: "draw",
        value: function draw(level) {
            ...
            var ind = Math.random() * level.textures.shield.length | 0;
            level.drawEntity(this.guanoShield, level.textures.shield[ind]);
        }
    }, {
        key: "update",
        value: function update(level, delta) {
            ...
            this.guanoShield.cx = this.cx;
            this.guanoShield.cy = this.cy;
        }
    }]);

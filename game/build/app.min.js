...
var WATER = 8;
var GRASS = 16;
var PREGRASS = 32; // adjacent for grass
var BRIDGEH = 64;
var BRIDGEV = 128;
var BOARD = 256;
...
var Level = function () {
                    ...
                    for (var i = 0; i < _this.mapWidth; i++) {
                        for (var dy = -1; dy < 2; dy++) {
                            for (var dx = -1; dx < 2; dx++) {
                                var x = i + dx | 0;
                                var y = j + dy | 0;
                                if (x >= 0 && x < _this.mapWidth && y >= 0 && y < _this.mapHeight && _this.map[y * _this.mapWidth + x] & GRASS) {
                                    _this.map[j * _this.mapWidth + i] |= PREGRASS;
                                }
                            }
                        }
                    }
    ...
    _createClass(Level, [{
        ...
        value: function drawTile(texture, srcx, srcy, dstx, dsty, size) {
            this.context.drawImage(texture, srcx * this.tileSize, srcy * this.tileSize, size * this.tileSize, size * this.tileSize, dstx * this.tileSize, dsty * this.tileSize, size * this.tileSize, size * this.tileSize);
        ...
        value: function collidePoint(x, y, mask) {
            if (x < 0 || x >= this.mapWidth || y < 0 || y >= this.mapHeight) return BOARD;

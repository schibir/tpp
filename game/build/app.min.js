...
var Bullet = exports.Bullet = function (_Entity) {
    ...
    function Bullet(owner) {
        ...
        var sina = [-1, 0, 1, 0];
        var cosa = [0, 1, 0, -1];
        var dx = cosa[owner.angle];
        var dy = sina[owner.angle];
...
var Level = function () {
    ...
    _createClass(Level, [{
        ...
        value: function collideEntity(entity, offset, mask) {
            var sina = [-1, 0, 1, 0];
            var cosa = [0, 1, 0, -1];
            var x = entity.cx + cosa[entity.angle] * offset * entity.size;
            var y = entity.cy + sina[entity.angle] * offset * entity.size;
            var x1 = x + cosa[entity.angle + 1 & 3] * 0.5;
            var y1 = y + sina[entity.angle + 1 & 3] * 0.5;
            var x2 = x - cosa[entity.angle + 1 & 3] * 0.5;
            var y2 = y - sina[entity.angle + 1 & 3] * 0.5;

...
var Level = function () {
    function Level(levelName, canvas) {
        ...
        loadLevel(function () {
            ...
            // test item
            _this.layer.context.drawImage(_this.textures.item[_global.ITEM.LIFE], 100, 160);
            _this.layer.context.drawImage(_this.textures.item[_global.ITEM.KNUKLE], 200, 160);
            _this.layer.context.drawImage(_this.textures.item[_global.ITEM.STAR], 300, 160);
            _this.layer.context.drawImage(_this.textures.item[_global.ITEM.SPEED], 400, 160);
            _this.layer.context.drawImage(_this.textures.item[_global.ITEM.FIREBALL], 500, 160);
...
},{"./gener/genTextures":5,"./global":6,"./utils":10}],8:[function(require,module,exports){
"use strict";

...
var Bullet = function (_Entity) {
    ...
    function Bullet(owner, callback) {
        _classCallCheck(this, Bullet);

        var dx = (0, _utils.cos)(owner.angle);
        var dy = (0, _utils.sin)(owner.angle);

        var _this = _possibleConstructorReturn(this, (Bullet.__proto__ || Object.getPrototypeOf(Bullet)).call(this, owner.cx + dx, owner.cy + dy, 1, owner.angle, 2.88));
...
},{"./entity":2,"./utils":10}],2:[function(require,module,exports){
"use strict";
...
var GenTextures = function GenTextures(tileSize) {
    ...
    for (var _i5 = 1; _i5 < countAnimRespawn; _i5++) {
        var koef = 0.3 * Math.sin(_i5 / countAnimRespawn * Math.PI * 2);
        this.respawn[_i5] = scaleImage(this.respawn[0], [1 + koef, 1 - koef]);
    }
...
var Level = function () {
    ...
    _createClass(Level, [{
        ...
        key: "collideBullet",
        value: function collideBullet(entity) {
            var _this2 = this;
...
var Weapon = function () {
    ...
    _createClass(Weapon, [{
        ...
        value: function setType(type) {
            this.type = type;
            this.count = this.type === _global.BULLET.DOUBLE || this.type === _global.BULLET.POWER ? 2 : 1;
        }
    }, {
        key: "shoot",
        value: function shoot() {
            ...
            if (this.count) {
                this.count--;
                return new _bullet2.default(this.owner, function () {
                    return _this.count++;
                });
            }
            return null;

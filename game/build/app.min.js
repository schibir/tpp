...
var Game = function () {
    function Game(canvas, params) {
        ...
        var tank1 = this.tanks.create(10, 10, _global.TANK.TANK1);
        var tank2 = params.twoplayers === "true" ? this.tanks.create(15, 10, _global.TANK.TANK2) : null;
...
var Tank = function (_Entity) {
    ...
    function Tank(cx, cy, type) {
        ...
        _this.animTrack = 0;
        _this.animTurret = 0;
        _this.turret = new _entity.Entity(cx, cy);

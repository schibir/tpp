...
function main() {
    ...
    var cementImg = cement.perlin(5, 0.5).diff([1, 0.5]).normalize(0, 1).getColor((0, _utils.randColor)([100, 100, 100], 10));
    ...
    var brickImg = brick.brick(5, 10).forBuf(noise, function (a, b) {
        return a * b;
    }).normalize(0.75, 1).getColor((0, _utils.randColor)([160, 54, 35], 10));

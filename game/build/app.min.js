...
var BulletManager = exports.BulletManager = function () {
    ...
    _createClass(BulletManager, [{
        ...
        value: function draw(level) {
            this.bullets.forEach(function (bullet) {
                return bullet.draw(level);
            });
        }
    }, {
        key: "push",
        value: function push(bullet) {
        ...
        value: function update(level, delta) {
            ...
            var collide = function collide(bullet) {
                ...
                for (var i = 0; i < _this2.bullets.length; i++) {
                    if (_this2.bullets[i].alive && bullet.collide(_this2.bullets[i], 0.5, 0.5)) {
                        var myFire = !!(bullet.type & _global.BULLET.FIRE);
                        var otherFire = !!(_this2.bullets[i].type & _global.BULLET.FIRE);
                        if (!myFire || otherFire) bullet.died();
                        if (!otherFire || myFire) _this2.bullets[i].died();
                        return;
                    }
                }
            };
            ...
            for (var index = 0; index < this.bullets.length;) {
...
var Particle = function () {
    function Particle(cx, cy) {
        ...
        this.entity = new _entity2.default(cx, cy);
    ...
    _createClass(Particle, [{
        ...
        key: "draw",
        value: function draw(level, delta) {
...
var Tank = function (_Entity) {
    ...
    function Tank(cx, cy, type) {
        ...
        _this.animTrack = 0;
        _this.animTurret = 0;
        _this.turret = new _entity2.default(cx, cy);

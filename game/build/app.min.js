...
var GenTextures = function GenTextures(tileSize) {
    ...
    var sparksBrick = new _buffer2.default(tileSize * 0.5 | 0);
    this.sparksBrick = sparksBrick.normDist(1).normalize(0, 1).clamp(0.1, 0.3).normalize(0, 1).forBuf(sparkNoise, function (a, b) {
        return a * b;
    }).getColor((0, _utils.randColor)([200, 80, 60]), sparksBrick);
    ...
    _createClass(Particle, [{
        ...
        value: function update(level, delta) {
            ...
            if (this.deltatime >= this.lifetime) {
                this.alive = false;
                if (this.type === _global.PART.BRICK) level.drawEntityToAllLayers(this.entity, level.textures.sparksBrick);
            }
...
var ParticleManager = function (_EntityManager) {
    ...
    _createClass(ParticleManager, [{
        ...
        value: function emit(cx, cy, type) {
            var count = type === _global.PART.FIRE ? 1 : 5;

...
var Level = function () {
    ...
    _createClass(Level, [{
        ...
        key: "collideEntity",
        value: function collideEntity(entity, mask) {
            var sina = [-1, 0, 1, 0];
            var cosa = [0, 1, 0, -1];
            var x = entity.cx + cosa[entity.angle] * 0.5 * entity.size;
            var y = entity.cy + sina[entity.angle] * 0.5 * entity.size;
...
var Tank = exports.Tank = function (_Entity) {
    ...
    function Tank(cx, cy, type) {
        ...
        _this.type = type;
        _this.animTrack = 0;
        _this.weapon = new _weapon2.default(_this, _bullet.BULLET.DOUBLE);
        _this.shoot = false;
        return _this;
    }

...
var Bullet = exports.Bullet = function (_Entity) {
    ...
    _createClass(Bullet, [{
        ...
        key: "update",
        value: function update(level, delta) {
...
var BulletManager = exports.BulletManager = function (_EntityManager) {
    ...
    _createClass(BulletManager, [{
        ...
        value: function update(level, delta) {
            ...
            _get(BulletManager.prototype.__proto__ || Object.getPrototypeOf(BulletManager.prototype), "update", this).call(this, level, delta);
        }
    }]);
...
var Tank = function (_Entity) {
    ...
    _createClass(Tank, [{
        ...
        key: "update",
        value: function update(level, tanks, delta) {
            if (this.state === _global.STATE.RESPAWN) {
                ...
                if (this.state === _global.STATE.GOD) {
                    if (Date.now() > this.stateTime) this.state = _global.STATE.NORMAL;
                }
...
var TankManager = function (_EntityManager) {
    ...
    _createClass(TankManager, [{
        key: "create",
        value: function create(cx, cy, type) {
            var tank = new Tank(cx, cy, type);
        ...
        key: "update",
        value: function update(level, bullets, delta) {
            var _this3 = this;

            this.objects.forEach(function (tank) {
                tank.update(level, _this3.objects, delta);

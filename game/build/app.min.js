    ...
    var renderLava = function renderLava() {
        _this.map.forEach(function (tile, index) {
            if (tile === WATER) {
                ...
                var posX = x * tileSize;
                var posY = y * tileSize;
                var srcX = posX % _this.textures.lava.width | 0;
                var srcY = posY % _this.textures.lava.height | 0;
                _this.layerGround.context.drawImage(_this.textures.lava, srcX, srcY, // srcPos

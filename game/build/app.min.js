...
var Level = function () {
    function Level(levelName, canvas) {
        ...
        loadLevel(function () {
            ...
            _this.layer.context.drawImage(_this.textures.decal, 100, 130);
            ...
            _this.layer0.context.drawImage(_this.textures.decal, 100, 130);
            ...
            _this.layer1.context.drawImage(_this.textures.decal, 100, 130);
...
var Tank = function (_Entity) {
    ...
    _createClass(Tank, [{
        ...
        value: function update(level, delta) {
            ...
            this.move(delta);
            if (level.collideTank(this)) this.move(-delta);else if (this.vel > 0.01) {

...
var Game = function () {
    function Game(difficulty, canvas) {
        ...
        this.tanks = [];
        for (var type = _tank.TANK.SIMPLE; type <= _tank.TANK.PANZER; type++) {
            this.tanks.push(new _tank.Tank(1 + type * 3, 5, type));
        }
    ...
    _createClass(Game, [{
        ...
        value: function update() {
            ...
            this.tanks.forEach(function (tank) {
                return tank.update(_this.level, delta);
            });
        ...
        value: function onkeydown(key) {
            ...
            this.tanks.forEach(function (tank) {
                if (key in keyToAngle[0]) {
                    tank.angle = keyToAngle[0][key];
                    tank.vel = 0.05;
                }
            });
        }
        ...
        value: function onkeyup(key) {
            ...
            this.tanks.forEach(function (tank) {
                if (_this2.keyMask[0] in maskToAngle) {
                    tank.angle = maskToAngle[_this2.keyMask[0]];
                } else {
                    tank.vel = 0;
                }
            });

...
var Level = function () {
    ...
    _createClass(Level, [{
        ...
        value: function clearEntity(entity) {
            ...
            this.context.drawImage(this.layer.canvas, x * this.tileSize, y * this.tileSize, // src pos
        ...
        value: function drawEntity(entity, texture) {
            ...
            if (this.collidePoint(entity.cx, entity.cy, PREGRASS | GRASS)) {
                this.context.drawImage(this.layerGrass.canvas, x * this.tileSize, y * this.tileSize, // src pos
                entity.size * this.tileSize, entity.size * this.tileSize, // src size
                x * this.tileSize, y * this.tileSize, // dest pos
                entity.size * this.tileSize, entity.size * this.tileSize); // dest size

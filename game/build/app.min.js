...
var Particle = function () {
    function Particle(cx, cy, type) {
        ...
        this.entity = new _entity.Entity(cx, cy, 0.5, Math.random() * 2 * Math.PI, (0, _utils.rand)(1, 0.5));
        this.type = type;
        ...
        if (type === _global.PART.FIRE) this.entity.size = 2;
        if (type & (_global.PART.BRICK | _global.PART.BETON)) {
            this.entity.cx += (0, _utils.rand)(0, 0.5);
            this.entity.cy += (0, _utils.rand)(0, 0.5);
            this.lifetime += (0, _utils.rand)(0, 100);
            this.maxvel = this.entity.vel;
            this.startAngle = Math.random();
            this.omega = (0, _utils.rand)(0, 1 / 30);
        }
    }
                    ...
                    case _global.PART.FIRE:
                        {
                            ...
                            level.drawEntity(this.entity, level.textures.sparksFire[id][_ind]);
                            break;
                        }

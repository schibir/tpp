...
var Level = function () {
    ...
    _createClass(Level, [{
        ...
        key: "collideEntity",
        value: function collideEntity(entity, offset, mask) {
            var x = entity.cx + (0, _utils.cos)(entity.angle) * offset * entity.size;
            var y = entity.cy + (0, _utils.sin)(entity.angle) * offset * entity.size;

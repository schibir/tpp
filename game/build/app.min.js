...
var GenTextures = function GenTextures(tileSize) {
    ...
    this.lavaMask = lavaMask.normDist(1).normalize(0, 1).getColor([255, 255, 255], lavaMask);
    ...
    var renderLava = function renderLava() {
        _this.map.forEach(function (tile, index) {
            if (tile & (WATER | BRIDGE)) {
                ...
                _this.layerLava.context.drawImage(_this.textures.lavaMask, posX, posY);
            }
        });

        var old = _this.layerLava.context.globalCompositeOperation;
        ...
        _this.layerLava.context.globalCompositeOperation = old;
    };

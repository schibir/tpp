...
var KEY_PLAYER_TWO = (_KEY_PLAYER_TWO = {}, _defineProperty(_KEY_PLAYER_TWO, "W".charCodeAt(0), 0), _defineProperty(_KEY_PLAYER_TWO, "D".charCodeAt(0), 1), _defineProperty(_KEY_PLAYER_TWO, "S".charCodeAt(0), 2), _defineProperty(_KEY_PLAYER_TWO, "A".charCodeAt(0), 3), _KEY_PLAYER_TWO);
...
var Game = function () {
    function Game(difficulty, canvas) {
        ...
        this.tempTank = new _tank.Tank(10, 10, _tank.TANK.TANK1);

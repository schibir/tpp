...
var Bullet = function (_Entity) {
    ...
    _createClass(Bullet, [{
        ...
        value: function collideBullets(bullets) {
            ...
            for (var i = 0; i < bullets.length; i++) {
                if (bullets[i].alive && this.collide(bullets[i], 0.5, 0.5)) {
                    var myFire = !!(this.type & _global.BULLET.FIRE);
                    var otherFire = !!(bullets[i].type & _global.BULLET.FIRE);
        ...
        key: "updateBullets",
        value: function updateBullets(level, bullets, delta) {
            bullets.forEach(function (bullet) {
                return bullet.update(level, bullets, delta);
            });
...
var Game = function () {
    ...
    _createClass(Game, [{
        ...
        value: function update() {
            ...
            this.bullets.forEach(function (bullet) {
                return bullet.draw(_this.level);
            });
...
var Weapon = function () {
    ...
    _createClass(Weapon, [{
        ...
        value: function shoot() {
            ...
            if (this.count) {
                this.count--;
                return new _bullet2.default(this.owner, this.type, function () {
                    return _this.count++;
                });
            }
            return null;

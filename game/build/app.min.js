...
},{"./gener/genTextures":5,"./utils":11}],8:[function(require,module,exports){
"use strict";
...
var Particle = function () {
    function Particle(cx, cy, type) {
        ...
        var vel = (0, _utils.rand)(1, 0.5);
        var size = type === _global.PART.FIRE ? 2 : 0.5;
        this.entity = new _entity.Entity(cx, cy, size, angle, vel);
        this.type = type;
...
var Tank = function (_Entity) {
    ...
    function Tank(cx, cy, type) {
        ...
        _this.weapon = new _weapon2.default(_this, _global.BULLET.SIMPLE);
        _this.shoot = false;
        _this.alive = true;
        return _this;
    }

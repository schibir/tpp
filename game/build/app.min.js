...
exports.Bullet = exports.BULLET = undefined;
...
},{"./entity":2,"./utils":9}],2:[function(require,module,exports){
"use strict";
...
var Game = function () {
    ...
    _createClass(Game, [{
        ...
        value: function update() {
            ...
            // updating
            _tank.Tank.updateTanks(this.level, this.tanks, this.bullets, delta);
            _bullet.Bullet.updateBullets(this.level, this.bullets, delta);
...
},{"./bullet":1,"./entity":2,"./level":6,"./tank":8,"./utils":9}],4:[function(require,module,exports){
"use strict";
...
var GenTextures = function GenTextures(tileSize) {
    ...
    for (var _i2 = 1; _i2 < 4; _i2++) {
        ...
        for (var type = _tank.TANK.TANK1; type < _tank.TANK.RANDOM; type++) {
...
},{"../tank":8,"../utils":9,"./buffer":4}],6:[function(require,module,exports){
"use strict";
...
},{"./gener/genTextures":5,"./utils":9}],7:[function(require,module,exports){
"use strict";
...
},{"./game":3,"./utils":9}],8:[function(require,module,exports){
"use strict";
...
var Tank = exports.Tank = function (_Entity) {
    ...
    function Tank(cx, cy, type) {
        ...
        _this.weapon = new _weapon2.default(_this, _bullet.BULLET.SIMPLE);
        _this.shoot = false;
        return _this;
    }
...
},{"./bullet":1,"./entity":2,"./utils":9,"./weapon":10}],9:[function(require,module,exports){
"use strict";
...
var Weapon = function () {
    ...
    _createClass(Weapon, [{
        ...
        value: function setType(type) {
            this.type = type;
            this.count = this.type === _bullet.BULLET.DOUBLE || this.type === _bullet.BULLET.POWER ? 2 : 1;
        }
    }, {
        key: "shoot",
        value: function shoot() {
            ...
            if (this.count) {
                this.count--;
                return new _bullet.Bullet(this.owner, function () {
                    return _this.count++;
                });
            }
            return null;

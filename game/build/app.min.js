...
var Game = function () {
    ...
    _createClass(Game, [{
        ...
        value: function newLevel() {
            ...
            if (this.currentDifficulty === -2) levelName += test;else if (this.currentDifficulty === -1) levelName += bench;else levelName += "" + level + this.currentLevel;
...
},{"./level":4}],2:[function(require,module,exports){
"use strict";
...
var GenTextures = function GenTextures(tileSize) {
    ...
    var _loop = function _loop(k) {
        ...
        _this.bridge[k] = bridge.perlin(5, 0.5).forEach(function (a) {
            ...
            return a * b * b;
        }).normalize(0.5, 1).getColor((0, _utils.randColor)([182, 155, 76]), bridgeMask);
    };
    ...
    var easyColor = [120, 200, 120];
    var BMPColor = [200, 200, 200];
    var longColor = [250, 230, 134];
    var strongColor = [100, 200, 180];
    var panzerColor = [211, 229, 224];
    var player1Color = [200, 150, 100];
...
},{"../utils":6,"./buffer":2}],4:[function(require,module,exports){
"use strict";
...
var Level = function Level(levelName, canvas) {
    ...
    var renderBridge = function renderBridge() {
        _this.map.forEach(function (tile, index) {
            if (tile & BRIDGE) {
                ...
                if (tile === BRIDGEV) {
                    _this.layerLava.context.drawImage(_this.textures.bridge[ind], posX, posY);
                } else {
                    _this.layerLava.context.save();

                    _this.layerLava.context.translate(posX, posY);
                    _this.layerLava.context.rotate(Math.PI * 0.5);
                    _this.layerLava.context.scale(1, -1);
                    _this.layerLava.context.drawImage(_this.textures.bridge[ind], 0, 0);

                    _this.layerLava.context.restore();
                }
            }
        });
    };
    ...
    loadLevel(function () {
        ...
        _this.layerGround.context.drawImage(_this.layerLava.canvas, 0, 0);
        ...
        // test render tank
        _this.context.drawImage(_this.textures.trackSimple, 450, 600);
        _this.context.drawImage(_this.textures.corpusEasy, 450, 600);
        _this.context.drawImage(_this.textures.turretEasy, 450, 600);

        _this.context.drawImage(_this.textures.trackSimple, 450, 700);
        _this.context.drawImage(_this.textures.corpusStrong, 450, 700);
        _this.context.drawImage(_this.textures.turretStrong, 450, 700);

        _this.context.drawImage(_this.textures.trackSimple, 550, 700);
        _this.context.drawImage(_this.textures.corpusLong, 550, 700);
        _this.context.drawImage(_this.textures.turretLong, 550, 700);

        _this.context.drawImage(_this.textures.trackBMP, 550, 600);
        _this.context.drawImage(_this.textures.corpusBMP, 550, 600);
        _this.context.drawImage(_this.textures.turretBMP, 550, 600);

        _this.context.drawImage(_this.textures.trackPanzer, 650, 600);
        _this.context.drawImage(_this.textures.corpusPanzer, 650, 600);
        _this.context.drawImage(_this.textures.turretPanzer, 650, 600);

        _this.context.drawImage(_this.textures.trackSimple, 750, 600);
        _this.context.drawImage(_this.textures.corpusPlayer1, 750, 600);
        _this.context.drawImage(_this.textures.turretPlayer1, 750, 600);
...
},{"./gener/genTextures":3,"./utils":6}],5:[function(require,module,exports){
"use strict";
...
function main() {
    ...
    var game = new _game2.default(-2, canvas);
}
window.addEventListener("load", main);
},{"./game":1,"./utils":6}],6:[function(require,module,exports){
"use strict";

...
var GenTextures = function GenTextures(tileSize) {
    ...
    this.sparksBrick = sparksBrick.normDist(1).normalize(0, 1).clamp(0.1, 0.3).normalize(0, 1).getColor((0, _utils.randColor)([200, 80, 60]), sparksBrick);
...
var Particle = function () {
    ...
    _createClass(Particle, [{
        ...
        key: "draw",
        value: function draw(level) {
            var dt = Date.now() - this.creationTime;
            if (dt >= this.lifetime) {
                this.alive = false;
                ...
                switch (this.type) {
                    case _global.PART.SPARK:
                        {
                            var ind = dt / this.lifetime * level.textures.sparksBullet.length | 0;
                    ...
                    case _global.PART.FIRE:
                        {
                            ...
                            var _ind = dt / this.lifetime * level.textures.sparksFire[id].length | 0;
...
var Tank = function (_Entity) {
    ...
    function Tank(cx, cy, type) {
        ...
        _this.weapon = new _weapon2.default(_this, type === 0 ? _global.BULLET.DOUBLE | _global.BULLET.FIRE : _global.BULLET.SIMPLE);
        _this.shoot = false;
        _this.alive = true;
        return _this;
    }

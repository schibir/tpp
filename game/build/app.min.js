...
var Tank = exports.Tank = function (_Entity) {
    ...
    function Tank(cx, cy, type) {
        ...
        _this.testBullet = new _entity2.default(cx + 2, cy, 1);
        return _this;
    }
    ...
    _createClass(Tank, [{
        ...
        value: function clear(level) {
            ...
            level.clearEntity(this.testBullet);
        }
    }, {
        key: "draw",
        value: function draw(level) {
            ...
            level.drawEntity(this.testBullet, level.textures.bullet);
        }
    }, {
        key: "update",
        value: function update(level, delta) {
            ...
            this.testBullet.cx = this.cx + 2;
            this.testBullet.cy = this.cy;
        }
    }]);

...
var Game = function () {
    function Game(difficulty, canvas) {
        ...
        this.players = [new _tank2.default(10, 10, _global.TANK.TANK1), new _tank2.default(15, 10, _global.TANK.TANK2)];
    ...
    _createClass(Game, [{
        ...
        value: function update() {
            ...
            this.tanks.forEach(function (tank) {
                return tank.clear(_this.level);
            });
            this.bullets.clear(this.level);
            this.particles.clear(this.level);

            // updating
            _tank2.default.updateTanks(this.level, this.tanks, this.bullets, delta);
...
var Tank = function (_Entity) {
    ...
    _createClass(Tank, [{
        ...
        key: "update",
        value: function update(level, tanks, bullets, delta) {
        ...
        key: "collideBullets",
        value: function collideBullets(bullets) {
            var _this2 = this;

            bullets.objects.forEach(function (bullet) {
                if (!bullet.alive || bullet.owner === _this2) return;
                if (_this2.collide(bullet, (0, _global.tankRadius)(_this2.type), 0.5)) {
                    bullet.died();
                }
            });
        }
        ...
        key: "updateTanks",
        value: function updateTanks(level, tanks, bullets, delta) {

...
var Entity = exports.Entity = function () {
    ...
    _createClass(Entity, [{
        ...
        value: function move(delta) {
            ...
            var dx = (0, _utils.cos)(this.angle) * this.vel * delta * koef;
            var dy = (0, _utils.sin)(this.angle) * this.vel * delta * koef;
            this.cx += dx;
            this.cy += dy;
        }
    }, {
...
var Particle = function () {
    function Particle(cx, cy, type) {
        ...
        var size = type === _global.PART.FIRE ? 2 : 1;
        this.entity = new _entity.Entity(cx, cy, size);
        this.type = type;
...
},{"./entity":2,"./global":6}],10:[function(require,module,exports){
"use strict";
...
var Tank = function (_Entity) {
    ...
    function Tank(cx, cy, type) {
        ...
        _this.weapon = new _weapon2.default(_this, _global.BULLET.SIMPLE | _global.BULLET.FIRE);
        _this.shoot = false;
        _this.alive = true;
        return _this;
    }

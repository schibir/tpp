...
var BulletManager = exports.BulletManager = function (_EntityManager) {
    ...
    function BulletManager(particles) {
        ...
        _this2.particleCallback = function (bullet) {
            if (bullet.type & _global.BULLET.FIRE) {
...
var Particle = function () {
    function Particle(cx, cy) {
        ...
        this.entity = new _entity.Entity(cx, cy);
    ...
    _createClass(Particle, [{
        ...
        value: function draw(level) {
            ...
            if (dt >= this.lifetime) this.alive = false;else {
                ...
                var ind = dt / this.lifetime * level.textures.sparksFire[id].length | 0;

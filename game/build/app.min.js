...
function main() {
    ...
    var normDist = new _buffer2.default(128);
    normDist.normDist(1).normalize(0, 3).clamp(0, 1);

    var grassMask = new _buffer2.default(128);
    grassMask.perlin(20, 0.9).normalize(0, 1).forBuf(normDist, function (a, b) {
        return a * b;
    }).clamp(0.2, 0.5).normalize(0, 1);

    var grassImg = grass.getColorAlpha(grassMask, (0, _utils.randColor)([49, 107, 54]));

    var boardMask = new _buffer2.default(32);
    ...
    var board = new _buffer2.default(32);
    var boardImg = board.perlin(2, 0.5).normalize(0.7, 1).forBuf(boardMask, function (a, b) {
        return a * b;

...
var BulletManager = exports.BulletManager = function (_EntityManager) {
    ...
    function BulletManager() {
        ...
        return _possibleConstructorReturn(this, (BulletManager.__proto__ || Object.getPrototypeOf(BulletManager)).apply(this, arguments));
    }
            ...
            var collide = function collide(bullet) {
                ...
                for (var i = 0; i < _this3.objects.length; i++) {
                    if (_this3.objects[i].alive && bullet.collide(_this3.objects[i], 0.5, 0.5)) {
                        ...
                        if (!otherFire || myFire) _this3.objects[i].died();
                        return;
                    }
                }
            };
...
var Game = function () {
    function Game(difficulty, canvas) {
        ...
        this.bullets = new _bullet.BulletManager();
...
var Particle = function () {
    ...
    _createClass(Particle, [{
        ...
        key: "draw",
        value: function draw(level) {
            var ind = (Date.now() - this.creationTime) / 40 % level.textures.sparksFire.length | 0;

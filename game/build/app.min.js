...
var Tank = exports.Tank = function (_Entity) {
    ...
    function Tank(cx, cy, type) {
        ...
        _this.testBullet1 = new _entity2.default(cx, cy - 2, 2);
        _this.testBullet2 = new _entity2.default(cx + 2, cy, 1);
        return _this;
    }
    ...
    _createClass(Tank, [{
        ...
        value: function clear(level) {
            ...
            level.clearEntity(this.testBullet1);
            level.clearEntity(this.testBullet2);
        }
    }, {
        key: "draw",
        value: function draw(level) {
            ...
            level.drawEntity(this.testBullet1, level.textures.fireLong);
            level.drawEntity(this.testBullet2, level.textures.fireSmall);
        }
    }, {
        key: "update",
        value: function update(level, delta) {
            ...
            this.testBullet1.cx = this.cx;
            this.testBullet1.cy = this.cy - 2;
            this.testBullet2.cx = this.cx + 2;
            this.testBullet2.cy = this.cy;
        }
    }]);

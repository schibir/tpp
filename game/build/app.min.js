...
var GenTextures = function GenTextures(tileSize) {
    ...
    this.itemStar.getContext("2d").drawImage(this.fireSmall, tileSize * 0.5, tileSize * 0.5);
};
...
var Tank = function (_Entity) {
    ...
    function Tank(cx, cy, type) {
        ...
        _this.guanoItem = new _entity2.default(cx, cy);
        return _this;
    }
    ...
    _createClass(Tank, [{
        ...
        value: function clear(level) {
            level.clearEntity(this);
            level.clearEntity(this.guanoItem);
        }
    }, {
        key: "draw",
        value: function draw(level) {
            ...
            level.drawEntityBegin(this.guanoItem, level.textures.itemStar);
        }
    }, {
        key: "update",
        value: function update(level, delta) {
            ...
            this.guanoItem.cx = this.cx + 3;
            this.guanoItem.cy = this.cy;
        }
    }, {
        key: "updateWeapon",

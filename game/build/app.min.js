...
var GenTextures = function GenTextures(tileSize) {
    ...
    for (var _i2 = 1; _i2 < 4; _i2++) {
        ...
        for (var prop in _tank.TANK) {
            this.tankBodies[_i2][_tank.TANK[prop]] = rotateImage(this.tankBodies[0][_tank.TANK[prop]], _i2);
            this.tankTurret[_i2][_tank.TANK[prop]] = rotateImage(this.tankTurret[0][_tank.TANK[prop]], _i2);
            this.tankTrack[_i2][_tank.TANK[prop]] = new Array(countAnimTrack);
            for (var _offset = 0; _offset < countAnimTrack; _offset++) {
                this.tankTrack[_i2][_tank.TANK[prop]][_offset] = rotateImage(this.tankTrack[0][_tank.TANK[prop]][_offset], _i2);
            }
        }
    }
    ...
    var createFire = function createFire(size) {
        ...
        for (var _step = 0; _step < size * 0.75 | 0; _step++) {
            var plumeStep = new _buffer2.default(size);
            plumeStep.normDist(koef * 0.75 - koef * 0.75 * _step / (size * 0.75), 0, 0.5 - 2 * _step / size);
